...
const StudentExamMarks = ({ situation }) => {
    ...
    }, [situation, params, dispatch]); // Include `params`, `dispatch`, and `situation` in the dependency array

    useEffect(() => {
        if (userDetails && userDetails.sclassName && situation === "Student") {
            dispatch(getSubjectList(userDetails.sclassName._id, "ClassSubjects"));
        }
    }, [dispatch, userDetails, situation]); // Include `dispatch`, `userDetails`, and `situation` in the dependency array
